  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 max-w-7xl relative z-10">
        ...
        <div ref={contentRef} className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start mt-12">
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <motion.div
                ...
                className="flex flex-col items-center bg-white/90 rounded-lg p-6 shadow text-center"
              >
                ...
                <h4 className="font-medium text-gray-900 text-sm">{translations.about.stats.experience.label[language]}</h4>
                <p className="text-xs text-gray-500">{translations.about.stats.experience.subtext[language]}</p>
              </motion.div>
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                <h4 className="font-medium text-gray-900 text-sm">{translations.about.stats.recipes.label[language]}</h4>
                <p className="text-xs text-gray-500">{translations.about.stats.recipes.subtext[language]}</p>
              </motion.div>
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                <h4 className="font-medium text-gray-900 text-sm">{translations.about.stats.customers.label[language]}</h4>
                <p className="text-xs text-gray-500">{translations.about.stats.customers.subtext[language]}</p>
              </motion.div>
            </div>
          </motion.div>
          ...
          <div className="space-y-6">
            <motion.div
              ...
              className="h-[400px] lg:h-[450px] rounded-lg overflow-hidden shadow-xl relative group"
            >
              {/* Image Container */}
            ...
            >
              <div className="90 rounded-lg shadow-lg p-4 hover:shadow-xl transition-shadow duration-300">
                <img
                ...
                <div className="text-center mt-2">
                  <p className="text-sm font-medium text-gray-800">Brihadisvara Temple</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
            {features.map((feature, index) => (
              <motion.div
                ...
                whileHover={{ y: -10 }}
                className="bg-white/90 p-8 rounded-lg shadow-md transform transition-all duration-300 hover:shadow-xl"
              >
